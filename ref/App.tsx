          ...
          <div className="settings-panel" onClick={e => e.stopPropagation()}>
            ...
            <div className="settings-content">
              ...
              <div className="setting-item">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <label>快捷键管理</label>
                  <button className="bulk-btn" style={{ padding: '4px 12px', background: 'rgba(255, 69, 58, 0.15)', borderColor: 'rgba(255, 69, 58, 0.4)' }} onClick={async () => {
                    if (!window.confirm('确定要重置所有快捷键吗？所有快捷键将被禁用。')) {
                      return;
                    }
                    try {
